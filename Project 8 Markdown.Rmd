...
\end{enumerate}
Doubly robust estimators guarantee consistency in that if we correctly estimate either the expectation of Y given the treatment and covariates or the expectation of the treatment given the covariates. If one of these are estimated consistengly then TMMLE will converge on the true parameter as the sample size approaches infinity. 
